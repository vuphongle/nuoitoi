        ...
        <div className="relative z-10 grid items-end gap-8 lg:grid-cols-[1.25fr_0.75fr]">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
              Khám phá những gương mặt quanh mình, tìm đồng đội cùng sở thích và biến văn phòng
              thành một nơi thân quen hơn.
            </p>
          ...
          <div className="hero-note rounded-3xl border border-white/70 bg-white/75 p-5 shadow-sm backdrop-blur">
            <div className="flex items-center gap-3">
              <span
                className="grid size-11 place-items-center rounded-2xl bg-mint-100 text-xl"
                aria-hidden
              >
                ☀
              </span>
      ...
      <section className="mt-6 grid gap-4 sm:grid-cols-3">
        <article className="stat-card">
          ...
          <div className="mt-2 flex items-end justify-between">
            ...
            <span className="stat-icon bg-coral-50 text-coral-700" aria-hidden>
              ◎
            </span>
          </div>
        ...
        <article className="stat-card">
          ...
          <div className="mt-2 flex items-end justify-between">
            ...
            <span className="stat-icon bg-mint-50 text-mint-800" aria-hidden>
              ⌘
            </span>
          </div>
        ...
        <article className="stat-card">
          ...
          <div className="mt-2 flex items-end justify-between">
            ...
            <span className="stat-icon bg-amber-50 text-amber-700" aria-hidden>
              ♨
            </span>
          </div>
      ...
      <section className="mt-10 grid gap-5 lg:grid-cols-[1fr_0.8fr]">
            ...
            {newTeammates.map((employee) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate font-bold text-slate-900 group-hover:text-coral-700">
                    {employee.fullName}
                  </p>
                ...
                <span
                  className="text-slate-300 transition group-hover:translate-x-1 group-hover:text-coral-600"
                  aria-hidden
                >
                  →
                </span>
        ...
        <aside className="surface-card relative overflow-hidden bg-slate-950 p-6 text-white sm:p-7">
          ...
          <h2 className="relative mt-6 text-2xl font-black tracking-tight">
            Hồ sơ càng thật, kết nối càng dễ.
          </h2>
          <p className="relative mt-3 text-sm leading-6 text-slate-300">
            Thêm một câu giới thiệu và vài sở thích. Biết đâu bạn tìm được hội ăn trưa mới ngay hôm
            nay.
          </p>
          <Link
            className="relative mt-6 inline-flex items-center gap-2 text-sm font-bold text-coral-300 hover:text-white"
            href="/profile/edit"
          >
